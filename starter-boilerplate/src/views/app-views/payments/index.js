...
const IconUnpaid = () => (
  <svg width="56" height="50" viewBox="0 0 56 50" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M0 49.8799H56L28 0.879883L0 49.8799ZM30.5455 42.143H25.4545V36.9851H30.5455V42.143ZM30.5455 31.8273H25.4545V21.5115H30.5455V31.8273Z" fill="#FF8B00" />
  </svg>
);
...
function Payments() {
  ...
  const changeActive = (id) => {
    setListButton(listButton.map((item) => ({ ...item, active: item.id === id })));
  };
